								...
								<div class="project-desc">
									...
									<? if ($events->upcoming > 0): ?>
										<? if ($lang == $setting->setting__system_language): ?>
											<p><a href="<?= base_url(); ?>events/register/<?= $events->url_name; ?>/" class="btn-download">Register Now</a></p>
										<? else: ?>
											<p><a href="<?= base_url(); ?>events/register/<?= $events->url_name; ?>/" class="btn-download">Registrasi Sekarang</a></p>
										<? endif; ?>
									<? endif; ?>
								</div>
							</div>

				...
				<ul>
					<? foreach ($arr_header as $header): ?>
						<? if ($lang == $setting->setting__system_language || $header->name_lang == ''): ?>
							<li <? if ($header_id == $header->id): ?>class="konsulthink-active"<? endif; ?>><a href="<?= base_url(); ?><?= $header->link; ?>"><?= $header->name; ?></a></li>
						<? else: ?>
							<li <? if ($header_id == $header->id): ?>class="konsulthink-active"<? endif; ?>><a href="<?= base_url(); ?><?= $header->link; ?>"><?= $header->name_lang; ?></a></li>
						<? endif; ?>
					<? endforeach; ?>
				</ul>
			</nav>

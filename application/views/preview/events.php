						...
						<div class="row">
							<div class="col-md-7 col-sm-12 animate-box" data-animate-effect="fadeInLeft">
								<div class="blog-entry">
									<a href="<?= base_url(); ?>preview/events/detail/<?= $arr_upcoming_events[0]->url_name; ?>" class="blog-img"><img src="<?= $setting->setting__system_admin_url; ?>images/website/<?= $arr_upcoming_events[0]->image_name; ?>" class="img-responsive"></a>
								</div>
							</div>
							<div class="col-md-5 col-sm-12 animate-box" data-animate-effect="fadeInLeft">
								<div class="desc">
									...
									<? if ($lang == $setting->setting__system_language || $arr_upcoming_events[0]->name_lang == ''): ?>
										<h3><a href="<?= base_url(); ?>preview/events/detail/<?= $arr_upcoming_events[0]->url_name; ?>"><?= $arr_upcoming_events[0]->name; ?></a></h3>
									<? else: ?>
										<h3><a href="<?= base_url(); ?>preview/events/detail/<?= $arr_upcoming_events[0]->url_name; ?>"><?= $arr_upcoming_events[0]->name_lang; ?></a></h3>
									<? endif ?>
									...
									<? if ($lang == $setting->setting__system_language): ?>
										<a href="<?= base_url(); ?>preview/events/detail/<?= $arr_upcoming_events[0]->url_name; ?>" class="lead">Read More <i class="icon-arrow-right3"></i></a>
									<? else: ?>
										<a href="<?= base_url(); ?>preview/events/detail/<?= $arr_upcoming_events[0]->url_name; ?>" class="lead">Selengkapnya <i class="icon-arrow-right3"></i></a>
									<? endif; ?>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<? foreach ($arr_upcoming_events as $key => $upcoming_events): ?>
								...
								<div class="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
									<div class="blog-entry">
										<a href="<?= base_url(); ?>preview/events/detail/" class="blog-img"><img src="<?= $setting->setting__system_admin_url; ?>images/website/<?= $upcoming_events->image_name; ?>" class="img-responsive"></a>
										...
										<div class="desc">
											...
											<? if ($lang == $setting->setting__system_language || $upcoming_events->name_lang == ''): ?>
												<h3><a href="<?= base_url(); ?>preview/events/detail/"><?= $upcoming_events->name; ?></a></h3>
											<? else: ?>
												<h3><a href="<?= base_url(); ?>preview/events/detail/"><?= $upcoming_events->name_lang; ?></a></h3>
											<? endif ?>
											...
											<? if ($lang == $setting->setting__system_language): ?>
												<a href="<?= base_url(); ?>preview/events/detail/" class="lead">Read More <i class="icon-arrow-right3"></i></a>
											<? else: ?>
												<a href="<?= base_url(); ?>preview/events/detail/" class="lead">Selengkapnya <i class="icon-arrow-right3"></i></a>
											<? endif; ?>
										</div>
									</div>
								</div>
					...
					<div class="container-fluid">
						...
						<div class="row">
							<? foreach ($arr_past_events as $key => $past_events): ?>
								<div class="col-md-4 col-sm-6 animate-box" data-animate-effect="fadeInLeft">
									<div class="blog-entry">
										<a href="<?= base_url(); ?>preview/events/detail/" class="blog-img"><img src="<?= $setting->setting__system_admin_url; ?>images/website/<?= $past_events->image_name; ?>" class="img-responsive"></a>
										...
										<div class="desc">
											...
											<? if ($lang == $setting->setting__system_language || $past_events->name_lang == ''): ?>
												<h3><a href="<?= base_url(); ?>preview/events/detail/"><?= $past_events->name; ?></a></h3>
											<? else: ?>
												<h3><a href="<?= base_url(); ?>preview/events/detail/"><?= $past_events->name_lang; ?></a></h3>
											<? endif ?>
